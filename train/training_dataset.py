...
class TrainingDataset(Dataset):
    def __init__(self, csv_filename, root_dir, clip_length, frame_rate, clips_per_segment, temporal_jittering,
        ...
        df = TrainingDataset.remove_short_segments(pd.read_csv(csv_filename), clip_length,
                                                   frame_rate)
        self.df = TrainingDataset.check_files_exist(df, root_dir)
    ...
    def __getitem__(self, idx):
        ...
        idx = TrainingDataset.resample_video(self.clip_length, fps, self.frame_rate)
    ...
    @staticmethod
    def remove_short_segments(df, clip_length, frame_rate):
