...
class EvalVideoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        filename, fps, clip_t_start, is_last_clip = row['filename'], row['fps'], row['clip-t-start'], row[
            'is-last-clip']
        ...
        vframes = vframes[idxs][
                  :self.clip_length]  # [:self.clip_length] for removing extra frames if isinstance(idxs, slice)
